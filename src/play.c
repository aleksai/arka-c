...
void play(void)
{
    ...
    Paint_DrawLine(20, 10, 70, 60, 0xFF00, DOT_PIXEL_1X1, LINE_STYLE_SOLID);
    Paint_DrawLine(70, 10, 20, 60, 0xFF00, DOT_PIXEL_1X1, LINE_STYLE_SOLID);
    Paint_DrawLine(170, 15, 170, 55, 0xFF00, DOT_PIXEL_1X1, LINE_STYLE_DOTTED);
    Paint_DrawLine(150, 35, 190, 35, 0xFF00, DOT_PIXEL_1X1, LINE_STYLE_DOTTED);
